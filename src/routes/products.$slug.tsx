    ...
    <div className="min-h-screen bg-obsidian">
      ...
      <section className="relative overflow-hidden pt-32 pb-24">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, var(--obsidian) 30%, color-mix(in oklab, var(--obsidian) 40%, transparent) 70%, transparent 100%)",
          }}
        />
        <div
        ...
        <div className="relative z-10 mx-auto grid max-w-[1320px] grid-cols-1 items-center gap-14 px-8 lg:grid-cols-12">
          <motion.div initial="hidden" animate="show" variants={stagger} className="lg:col-span-7">
            ...
            <motion.h1
              variants={fadeUp}
              className="text-display max-w-3xl text-[clamp(2.5rem,6vw,5.25rem)] leading-[1.04] text-ivory"
              style={{ textShadow: "0 2px 18px rgba(0,0,0,0.55)" }}
            >
              {cat.hero.headline}<br />
              <span className="italic text-gold">{cat.hero.italic}</span>
            </motion.h1>
            <motion.p variants={fadeUp} className="mt-7 max-w-xl text-base leading-relaxed text-ivory/85">
              {cat.hero.pitch}
            </motion.p>
          ...
          >
            <div
              ...
              style={{ background: "var(--gradient-gold)", opacity: 0.18, filter: "blur(60px)" }}
            />
            <motion.img
              src={cat.image}
              alt={cat.title}
              width={1024}
              height={1024}
              className="relative h-[60vh] w-full rounded-3xl border border-gold/20 object-cover"
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 hidden rounded-2xl border border-gold/30 bg-obsidian/90 p-5 backdrop-blur-xl md:block"
            >
              <div className="text-eyebrow text-[9px]">Lot No.</div>
              <div className="text-display mt-1 text-lg text-ivory">CL · 2026 · {String(idx + 1).padStart(3, "0")}</div>
              <div className="mt-1 text-[9px] tracking-[0.25em] text-ivory/50">{cat.items.length} SKU IN RANGE</div>
            </motion.div>
          </motion.div>
        </div>
      </section>
