...
import ritualGreensSprite from "@/assets/ritual-greens-turntable.webp.asset.json";
...
export const categories: Category[] = [
  {
    ...
    heroSprite: { url: ritualGreensSprite.url, frames: 48, cols: 8, rows: 6, aspect: 280 / 438 },
    items: [
