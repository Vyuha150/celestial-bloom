...
import ritualGreensSprite from "@/assets/ritual-greens-turntable-v3.webp.asset.json";
...
export const categories: Category[] = [
  {
    ...
    heroSprite: { url: ritualGreensSprite.url, frames: 72, cols: 9, rows: 8, aspect: 300 / 483 },
    items: [
